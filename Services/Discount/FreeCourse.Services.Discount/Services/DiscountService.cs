...
{
    public class DiscountService : IDıscountService
    {
        ...
        {
            //burada DBConnectionu constructor ile almıyoruz çünkü NpgsqlConnection NEWLİYORUZ BU DBConnectionu REFERANS ALIYOR 
        ...
        public async Task<Response<NoContent>> Save(Models.Discount discount)
        {
            ...
            return Response<NoContent>.Fail("ann error accured while adding" ,500);//discount dolu geliyorsa 500 benden kaynaklı demekki
                                                                                   //eklemiyuor eklerken hata yazdırdık bağlantı olamayablir
                                                                                   //vs 500 bundan dolayı yazdık 404 yazmadık dikkat et
